...
<head>
    ...
    <title>Sign in</title>
    <link rel="stylesheet" href="csshaha.css">
</head>
...
<body class="align">
    ...
    <div class="grid">
        ...
        <p class="text--center">Not Registered Yet? <a href="registration.php">Sign up now</a> <svg class="icon">
...
<body>
    <div class="container">
        ...
        if (isset($_POST["login"])) {
            ...
            require_once "database.php"; // Ensure this file is correctly configured
